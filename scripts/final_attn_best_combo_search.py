...
OUTPUT_ROOT = ROOT / "backup" / "final" / "attn_best_combo_search"
...
DATASET_SPECS: dict[str, DatasetSpec] = {
    "reut": DatasetSpec(
        ...
        candidates=(
            ...
            _candidate(
                key="hist_10run_anchor_20260421",
                label="Historical 10-run anchor",
                source="experiment_output/reut/reut_train_with_dual_attn_20260421_002712.txt",
                note="Historical full 10-run strict center with the best old mean before the final push.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
            ...
            _candidate(
                key="hist_10run_alt_20260402",
                label="Historical 10-run alt",
                source="experiment_output/reut/reut_train_with_dual_attn_20260402_211029.txt",
                note="Older strict 10-run Reuters center with stronger NMI/ARI mean than some later lines.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=256,
            ...
            _candidate(
                key="project_stable_center",
                label="Current project stable center",
                source="experiment.py",
                note="Current main-project Reuters strict center, included as a stability baseline in the final combo search.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
        ...
        ae_variants=(
            _ae_variant(
                ...
                note="AE seed 42 / k15 asset used by the Reuters apex sweep.",
            ),
            _ae_variant(
                key="project_current",
    ...
    "uat": DatasetSpec(
        ...
        candidates=(
            ...
            _candidate(
                key="hist_10run_anchor_20260420",
                label="Historical 10-run anchor",
                source="experiment_output/uat/uat_train_with_dual_attn_20260420_134130.txt",
                note="Historical strict 10-run UAT center that backed the earlier stable row.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
            ...
            _candidate(
                ...
                label="Current project stable center",
                source="experiment.py",
                note="Current main-project UAT strict center, included as an alternate stability-first baseline.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
    ...
    "amap": DatasetSpec(
        ...
        candidates=(
            ...
            _candidate(
                key="peak_minw008_bal005",
                label="Historical all-metric alt",
                source="experiment_output/amap_push_tuning/README.md",
                note="Strong AMAP all-metric alternate branch from the same peak search family.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
            ...
            _candidate(
                key="micro_lr9e5_ep450",
                label="Historical micro alt",
                source="experiment_output/amap_push_tuning/README.md",
                note="Stable nearby AMAP micro-tuned branch that stayed close to the peak on all metrics.",
                t=4,
                linlayers=1,
                epochs=450,
                dims=500,
            ...
            _candidate(
                ...
                label="Current project stable center",
                source="experiment.py",
                note="Current main-project AMAP strict center, included as the post-push engineering baseline.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
    ...
    "usps": DatasetSpec(
        ...
        candidates=(
            ...
            _candidate(
                key="plateau_balance010_weight025",
                label="Historical plateau alt",
                source="experiment_output/usps_push_tuning/20260505_usps_manual_attn_dcgl_only/README.md",
                note="Flat nearby USPS plateau point under the same best AE asset, useful for testing whether the broad plateau stabilizes 10-run mean better.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
                ...
                warmup_epochs=35,
                dcgl_neg_tau=0.5,
                dcgl_neg_weight=0.25,
            ),
            _candidate(
                key="project_stable_center",
                label="Current project stable center",
                source="experiment.py",
                note="Current main-project USPS strict center, included as a conservative engineering baseline.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
        ...
        ae_variants=(
            _ae_variant(
                key="manual_best_seedm7_k15",
                label="Historical best AE",
    ...
    "eat": DatasetSpec(
        ...
        candidates=(
            ...
            _candidate(
                key="hist_anchor_tau05_w06",
                label="Historical apex anchor",
                source="experiment_output/eat_push_tuning/20260505_eat_manual_attn_dcgl_only/README.md",
                note="Original reproduced EAT apex before widening the negative plateau.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
            ...
            _candidate(
                ...
                label="Current project stable center",
                source="experiment.py",
                note="Current main-project EAT strict center, included as an engineering baseline despite its weaker historical behavior.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
        ...
        ae_variants=(
            _ae_variant(
                key="sens_k15",
                label="Historical k15 AE",
                graph_relpath="data/ae_graph/sensitivity/ae_k_15/eat_ae_graph.txt",
                pkl_relpath=None,
                note="Historical EAT k15 AE graph that reproduces the old apex.",
            ),
            _ae_variant(
                key="project_current",
                label="Current project AE",
            ...
            _ae_variant(
                key="sens_k10",
                label="Sensitivity k10 AE",
                graph_relpath="data/ae_graph/sensitivity/ae_k_10/eat_ae_graph.txt",
                pkl_relpath=None,
                note="Secondary EAT AE family with decent transfer under the near-apex center.",
            ),
            _ae_variant(
                key="sens_k5",
                label="Sensitivity k5 AE",
                graph_relpath="data/ae_graph/sensitivity/ae_k_5/eat_ae_graph.txt",
                pkl_relpath=None,
                note="Structure-leaning secondary EAT AE family included for completeness.",
            ),
        ),
    ),
    "cora": DatasetSpec(
        ...
        candidates=(
            ...
            _candidate(
                key="hist_10run_anchor_20260418",
                label="Historical 10-run anchor",
                source="experiment_output/cora/cora_train_with_dual_attn_20260418_135450.txt",
                note="Best old strict-narrative Cora 10-run center before the later k5 asset discovery.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
            ...
            _candidate(
                key="k5_structure_branch",
                label="k5 structure branch",
                source="experiment_output/cora_push_tuning/20260505_cora_manual_attn_dcgl_only/README.md",
                note="Strong Cora branch favoring ACC/NMI/ARI over F1, useful for final combo comparison.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
        ...
        ae_variants=(
            _ae_variant(
                key="sens_k5",
                label="Historical k5 AE",
                graph_relpath="data/ae_graph/sensitivity/ae_k_5/cora_ae_graph.txt",
                pkl_relpath=None,
                note="Historical Cora k5 AE graph from strict manual tuning.",
            ),
            _ae_variant(
                key="project_current",
                label="Current project AE",
            ...
            _ae_variant(
                key="sens_k15",
                label="Sensitivity k15 AE",
                graph_relpath="data/ae_graph/sensitivity/ae_k_15/cora_ae_graph.txt",
                pkl_relpath=None,
                note="Historical sensitivity k15 Cora AE family, kept as a fallback family.",
            ),
        ),
    ),
    "cite": DatasetSpec(
        ...
        candidates=(
            ...
            _candidate(
                key="backup_midstrict_tau050",
                label="Backup mid-strict tau=0.50",
                source="experiment_output/cite_push_tuning/20260505_cite_manual_attn_dcgl_only/README.md",
                note="Recovered backup CiteSeer mid-strict center before the tau correction, useful as a local baseline.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
            ...
            _candidate(
                key="backup_highstrict_tau050",
                label="Backup high-strict tau=0.50",
                source="experiment_output/cite_push_tuning/20260505_cite_manual_attn_dcgl_only/README.md",
                note="Recovered backup CiteSeer high-strict branch that restored the old performance band.",
                t=4,
                linlayers=1,
                epochs=400,
                dims=500,
        ...
        ae_variants=(
            ...
            _ae_variant(
                key="sens_k10",
                label="Sensitivity k10 AE",
                graph_relpath="data/ae_graph/sensitivity/ae_k_10/cite_ae_graph.txt",
                pkl_relpath=None,
                note="Best non-backup sensitivity CiteSeer AE tested during the strict manual pass.",
            ),
        ),
    ),
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Search the final reproducible best combo for the seven tuned "
            "attn/DCGL-negative-only datasets by comparing multiple historical "
            "parameter centers against multiple AE assets, then archive the "
            "selected best reusable combo under backup/final."
        )
    )
    parser.add_argument(
        "--dataset",
    ...
    parser.add_argument(
        ...
        help="Root directory for combo-search logs, summaries, and selected assets.",
    )
    parser.add_argument(
        "--resume",
        action="store_true",
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Import reusable scenario JSON files from the older attn_tuned_10run_ae_compare output root before running.",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
...
def import_legacy_results(output_root: Path, datasets: list[str]) -> int:
    legacy_root = ROOT / "backup" / "final" / "attn_tuned_10run_ae_compare" / "results"
    if not legacy_root.exists():
        return 0
    imported = 0
    for dataset in datasets:
        src_dir = legacy_root / dataset
        dst_dir = output_root / "results" / dataset
...
def write_dataset_readme(
    ...
    asset_dir.mkdir(parents=True, exist_ok=True)
    lines = [
        f"# {spec.label} Final 10-run Combo Search",
        "",
...
def write_overall_summary(
    ...
    lines = [
        "# Final Attn Best Combo 10-run Summary",
        "",
        f"- Generated at: `{datetime.now().isoformat()}`",
        f"- Run stamp: `{run_stamp}`",
        f"- Manifest: `backup/final/attn_best_combo_search/manifests/manifest_{run_stamp}.json`",
        "",
        "This summary freezes the final reproducible combo for each dataset:",
        "`best parameter center + best AE asset`, all verified by standard 10-run mean/std.",
        "",
        "## Final Selection",
        "",
    ...
    for dataset in manifest["datasets"]:
        ...
        lines.append("")
        lines.append("- AE variants:")
        for ae_info in spec_info["ae_variants"]:
            lines.append(
                f"  - `{ae_info['key']}`: `{ae_info['graph_relpath']}`"
            )
...
def write_execution_report(
    ...
    lines = [
        "# Final Attn Best Combo Execution Report",
        "",
        f"- Generated at: `{datetime.now().isoformat()}`",
        f"- Run stamp: `{run_stamp}`",
        f"- Output root: `backup/final/attn_best_combo_search`",
        "",
        "This report freezes the final reproducible combo per dataset.",
        "Each combo is defined as:",
        "- one parameter center",
        "- one AE graph asset",
        "- standard `train.py --runs 10 --seed_start 0` verification",
        "",
        "## Final Choices",
        "",
    ]
    for dataset in manifest["datasets"]:
        ...
        lines.append(f"### {spec_info['label']}")
        lines.append("")
        lines.append(f"- Selected candidate: `{row['candidate_key']}`")
        lines.append(f"- Selected AE variant: `{row['ae_key']}`")
        lines.append(f"- AE graph: `{row['ae_graph_relpath']}`")
        if row.get("ae_pkl_relpath"):
            lines.append(f"- AE pretrain: `{row['ae_pkl_relpath']}`")
        lines.append(f"- Selection rule: `{row.get('selection_rule', '')}`")
        metrics = row["metrics"]
        lines.append(
            f"- 10-run metrics: `ACC {metrics['ACC']['mean']:.2f} +- {metrics['ACC']['std']:.2f}`, "
            f"`NMI {metrics['NMI']['mean']:.2f} +- {metrics['NMI']['std']:.2f}`, "
            f"`ARI {metrics['ARI']['mean']:.2f} +- {metrics['ARI']['std']:.2f}`, "
            f"`F1 {metrics['F1']['mean']:.2f} +- {metrics['F1']['std']:.2f}`"
        )
        cmd = row.get("command", [])
        if cmd:
    ...
    report_path = output_root / f"execution_report_{run_stamp}.md"
    latest_path = output_root / "execution_report_latest.md"
    text = "\n".join(lines) + "\n"
...
def build_manifest(datasets: list[str], runs: int, seed_start: int, device: str, python_exe: str) -> dict[str, Any]:
    ...
    for dataset in datasets:
        ...
        ae_infos: list[dict[str, Any]] = []
        seen_hashes: set[str] = set()
        unique_hash_count = 0
        for ae_variant in spec.ae_variants:
            graph = _path(ae_variant.graph_relpath)
            if graph is None or not graph.exists():
                raise FileNotFoundError(f"Missing AE graph for {dataset}: {ae_variant.graph_relpath}")
            graph_hash = sha256_of(graph)
            ...
            ae_infos.append(
                {
                    "key": ae_variant.key,
                    "label": ae_variant.label,
                    "graph_relpath": ae_variant.graph_relpath,
                    "pkl_relpath": ae_variant.pkl_relpath,
                    "note": ae_variant.note,
                    "sha256": graph_hash,
                }
            )
        manifest["specs"][dataset] = {
            "label": spec.label,
            "cluster_num": spec.cluster_num,
            "ae_variant_count": len(spec.ae_variants),
            "unique_ae_hash_count": unique_hash_count,
            "ae_variants": ae_infos,
            "candidates": [
                {
                    "key": candidate.key,
...
def main() -> int:
    ...
    if args.import_legacy_results:
        imported = import_legacy_results(output_root, datasets)
        print(f"[INFO] imported_legacy_results={imported}")
    ...
    for dataset in datasets:
        ...
        variant_order = list(spec.ae_variants)
        ...
        for ae_variant in spec.ae_variants:
            copy_variant_asset(output_root, dataset, ae_variant.key, ae_variant)
        selected_variant = next(ae for ae in spec.ae_variants if chosen["ae_key"] == ae.key)
